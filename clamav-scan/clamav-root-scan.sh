...
LOGS_HISTORY="/opt/auto-clamIPS/auto-clamav/logs/logs_history/root-scan-history/root-scan-history-$(date +'%Y-%m-%d').log"
...
mkdir -p /opt/auto-clamIPS/auto-clamav/logs/logs_history/root-scan-history/
